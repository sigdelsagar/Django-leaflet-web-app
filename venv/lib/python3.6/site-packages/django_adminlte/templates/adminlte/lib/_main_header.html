...
<header class="main-header">
  ...
  <a href="{% block logo_href %}/{% endblock %}" class="logo">
    ...
    <span class="logo-mini">{% block logo_text_small %}<b>A</b>LTE{% endblock %}</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg">{% block logo_text %}<b>Admin</b>LTE{% endblock %}</span>
  </a>
  {% endblock %}
  ...
  <nav class="navbar navbar-static-top">
    ...
    {% block nav_bar_center %}{% endblock %} {% block nav_custom_menu %}
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        {% block header_dropdowns %} {% if request.user.is_authenticated %}
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              ...
              <div class="pull-right">
                <a href="{% block logout_url %}{% logout_url %}{% endblock %}" class="btn btn-default btn-flat">Sign
                  out</a>
              </div>
            </li>
            {% endblock %}
        ...
        {% endif %} {% endblock header_dropdowns %}
      </ul>
    </div>
